...
dog5 = Dog.create breed: 'Cane Corso', age: 5, name: 'liam', weight: 80, size: 'Large', life_expectancy: 12, sex: 'Male', price: 400
dog6 = Dog.create breed: 'Great Dane', age: 5, name: 'Luke', weight: 18, size: 'Small', life_expectancy: 13,sex: 'Male', price: 200
dog7 = Dog.create breed: 'Wolfhound', age: 4, name: 'Dyke', weight: 60, size: 'Large', life_expectancy: 10, sex: 'Male', price: 400
...
dog12 = Dog.create breed: 'Bullmastivel', age: 10, name: 'Roxy', weight: 65, size: 'Large', life_expectancy: 10, sex: 'Male', price: 100
